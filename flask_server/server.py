...
mul_model = keras.models.load_model(
    '/Users/oliverwandschneider/dev/PycharmProjects/hatespeech_classifier/model_saves/multi_class_rnn_other')
bin_model = keras.models.load_model(
    '/Users/oliverwandschneider/dev/PycharmProjects/hatespeech_classifier/model_saves/binary_class_rnn')
...
def process():
    ...
    if request.method == 'POST':
        ...
        values = [preprocessing.processString(val) for val in values]
        ...
        for inx in range(len(values)):
            ...
            results.append([inx + 1, values[inx], np.argmax(pred[inx]) == 1, hs_class])
